...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title><sitemesh:write property='title'>Bocaditos</sitemesh:write> - Bocaditos</title>
        ...
        <!-- Bootstrap style --> 
        <link id="callCss" rel="stylesheet" href="/themes/readable/bootstrap.min.css" media="screen"/>
